 ...
 * @author Admin
 */
public class UpdateDel extends javax.swing.JFrame {

    /**
     * Creates new form UpdateDel
     */
    public UpdateDel() {
        initComponents();
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        int x=JOptionPane.showConfirmDialog(null,"Do you really want to Delete ","Select",JOptionPane.YES_NO_OPTION);
if(x==0)
{
    String id=jTextField1.getText();
    try {
...
JOptionPane.showMessageDialog(null, e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateDel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
